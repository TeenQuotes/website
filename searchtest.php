...
<input type="text" name="q" style="width:115px;margin-bottom:10px;" placeholder="A user, a quote..."/><br/>
...
else
{
	if (empty($city) AND empty($country))
	{
		...
		foreach($keywords as $k){
			$kwSql .= "texte_english LIKE '%$k%' AND";
		}
		$kwSql = substr($kwSql, 0, -3);
