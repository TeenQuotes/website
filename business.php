	...
	<div class="post">
		...
		<div class="grey_post">
			<form action="?action=send" method="post"> 
				...
				<br />
				<textarea rows="10" cols="70" name="message" value="'.$enter_your_message_here.'" onblur="javascript:if(this.value==\'\'){this.value=\''.$enter_your_message_here.'\'}" onFocus="javascript:if(this.value==\''.$enter_your_message_here.'\'){this.value=\'\'}"/>'.$enter_your_message_here.'</textarea><br> 
				<br /> 
