...
guard :concat, :type => "js", :files => %w[jquery-2.1.0.min bootstrap.min detect ads mailgun-validator app], :input_dir => "public/assets/js", :output => "public/assets/js/scripts.min"
