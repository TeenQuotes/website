<?php
return array(
	'robotFooter'                => "Please do not reply to this message. This email was sent by our beloved robot ; unfortunately, our robot can't read (but we are trying hard). If you wish to contact us, visit the page ".URL::route('contact')." or send us an email directly at support@".Config::get('app.domain'),
	...
	'iconStories'                => Config::get('app.domain').'/assets/images/emails/stories.png',
