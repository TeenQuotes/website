...
if ($send_monday=="0" && $jour=="Mon") { // ENVOI DE MAIL LE LUNDI
$message = "$top_mail";
...
$query=mysql_query("SELECT * FROM newsletter");
	...
	$email=$donnees['email'];
	$unsuscribe= "<br /><span style=\"font-size:80%\">This email was adressed to you ($email) because you are subscribed to our newsletter. If you want to unsuscribe, please follow <a href=\"http://www.teen-quotes.com/newsletter.php?action=unsuscribe&email=$email\" target=\"_blank\"> this link</a></span>";
...
if ($send_monday=="1" && $jour=="Tue") { // RESET COMPTEUR MARDI
