			...
			<div id="footer-container">
				...
				<!-- INSTAGRAM -->
				<img src="{{ Lang::get('email.iconInstagram') }}" class="icon"/>{{ Lang::get('email.footerInstagram') }} <a href="http://instagram.com/{{ str_replace('@', '', Lang::get('layout.instagramUsername')) }}" title="Instagram">{{ Lang::get('layout.instagramUsername') }}</a><br/>
