...
// Fin des différents cas de <title></title>
		...
		<link rel="stylesheet" href="http://m.<?php echo $domaine; ?>/style.css" /> 
...
<body>
<div id="topbar">
	<a href="../"><img src="http://<?php echo $domaine; ?>/images/logo.png" style="height:50px" alt="Logo <?php echo $name_website; ?>" /></a>
