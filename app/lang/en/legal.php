...
return array(
	...
	<p>
		...
		The elements contained on the websites '.Lang::get('layout.nameWebsite').' are protected by Industrial design rights, the rights of author, trademark law and the applicable regulations to unfair competition and they can not be copied or reproduced in whole or in part without the prior written permission from '.Lang::get('layout.nameWebsite').'. No logo, graphic, sound or image from the website '.Lang::get('layout.nameWebsite').' can be copied, reproduced or distributed. '.Lang::get('layout.nameWebsite').' does not state any particular appropriate use for the content of submissions published by this site nor for the graphics in the site presented.<br/><br/>
		Every article and every graphic is supplied AS IS without any guarantee whatsoever. '.Lang::get('layout.nameWebsite').' excludes any kind of implicit guarantee regarding the information above mentioned, particularly any implicit guarantee of quality, of adequacy to a particular use, of property and of absence of piracy.<br/><br/>
		In no event and under no circumstance will '.Lang::get('layout.nameWebsite').' or its directors be responsible or liable to you or any third person in any manner for any indirect, consequential, exemplary, incidental or accessory damage nor for any damages resulting from the inappropriate interpretation of an article, lack of information and defamation or any other damage related to the paging of the information redistributed by this service.<br/><br/>
		The submissions redistributed and the graphics used on the website '.Config::get('app.domain').' may contain inaccuracies and misspells. Changes are periodically added to the information source referred to by the search engine.<br/><br/>
		Finally '.Lang::get('layout.nameWebsite').' reserves the right, at its sole discretion, to change and modify the services provided by this website. Provided that you are eligible for use of the site, you are granted a limited license to access and use the site and the site content to which you have properly gained access solely for your personal, non-commercial use in a non illicit manner and in no manner to prejudice '.Lang::get('layout.nameWebsite').' and users that contribute by the posting of comments and submissions.<br/><br/>
		Without limiting the general grounds of this article you may not use the website '.Config::get('app.domain').' in a manner to prejudice, put out of business, condemn and compromise '.Lang::get('layout.nameWebsite').'.<br/><br/>
	...
	<h2>What Information is Collected About Visitors?</h2>
	<p>
	...
	<p>
		...
		We will not use the information that we collect while you are using the Site, nor will we authorize third parties to use such information, to mail or email promotional offers directly to you unless you have specifically informed us that you would like to receive such promotional offers.<br/><br/>
		Otherwise, we may share information we collect while you are using the Site with our affiliates and with trusted third-party service providers who assist us in providing services. If you do not wish your personally identifiable information to be used or shared for these purposes, send a message to contact@".Config::get('app.domain').".<br/><br/>
		For information about use of your information by us and by third-party advertising service providers for advertising and by , see the section “Data Collected in Connection with Ad Serving and Targeting.”<br/><br/>
	...
	<p>
		We may use cookies, web beacons, pixel tags and similar technologies, and/or a third-party ad serving software, to collect non-personally identifiable information about site users and site activity, and we may use this information to, among other things, serve targeted advertisements on this site. The information collected allows us to analyze how users use the site and to track user interests, trends and patterns, thus allowing us to deliver more relevant advertisements to users.<br/><br/>
		We also may use third-party service providers to target and serve some of the advertisements you see on the pages of our Site, and these providers likewise may use their own cookies, web beacons, pixel tags and similar technologies to collect non-personally identifiable information from our Site. These service providers may use that information, sometimes in conjunction with similar non-personally identifiable information gathered through other websites, to deliver advertisements on this Site, and on other websites that participate in our service providers’ advertising networks, that are tailored to match the perceived interests of consumers. This information also may be used to help measure and research an advertisement’s effectiveness, or for other purposes.<br/><br/>
		The data collected in connection with the ad serving and ad targeting on our Site does not identify you personally and does not include your name, address, email address or telephone number, but it may include the IP address of your computer.<br/><br/>
	</p>
