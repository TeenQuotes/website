...
if (isset($_GET['p']))
{
        $page_p = mysql_real_escape_string($_GET['p']);
}
else 
{
        $page_p = 1; 
...
if ($page_p > $nombreDePages) {$page_p=$page_p -1;}

$page_p2 = $page_p + 1;
$page_p3 = $page_p - 1;
if ($page_p > 1){echo "<span class=\"page\"><a href=\"?p=$page_p3\">$previous_page</a> ||  ";}
if ($page_p == 1){ echo"<span class=\"page\">";}   echo " <a href=\"?p=$page_p2\">$next_page</a></span><br>";


$premierMessageAafficher = ($page_p - 1) * $nombreDeMessagesParPage;
...
if ($page_p > 1){echo "<span class=\"page_bottom\" ><a href=\"?p=$page_p3\">$previous_page</a> ||  ";}
if ($page_p == 1){ echo"<span class=\"page_bottom\">";}   echo " <a href=\"?p=$page_p2\">$next_page</a></span><br>";
 include "footer.php"; ?>