...
return [
    ...
    'requireLoggedInAddQuoteTitle'   => 'Hi! Who are you?',
    'requireLoggedInAddQuoteContent' => 'Before adding a quote, you need to be logged in. Having an account is just a matter of seconds and it will make you cooler, for sure. <i class="fa fa-smile-o"></i>',
    'signupButton'                   => "I'm a cool kid!",
    'signupText'                     => 'To create an account on '.Lang::get('layout.nameWebsite').' and be able to access all the advantages that come with it, fill in the form below, your account will be created in an instant!',
    ...
    'signinPageDescription'          => 'Log in to your account and enter in your space on '.Lang::get('layout.nameWebsite').'.',
    ...
    'heyEmail'                       => 'Hey!',
    'askedResetPasswordEmail'        => "You've just asked to reset your password on ".Lang::get('layout.nameWebsite').' and we are here to help!<br/><br/>Click the link, complete the form and you will be out of trouble in a minute:',
