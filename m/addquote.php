...
if (empty($action)) 
{
	echo '
	<div class="post">
		<h2><img src="http://teen-quotes.com/images/icones/add.png" class="icone" />'.$add_quote.'</h2>
		'.$add_consignes.'
		<div class="grey_post">
			<form action="?action=add_quote" method="post">
				'.$enter_quote.'<br/>
				<textarea name="texte_quote" placeholder="'.$placeholder_addquote.'" style="width:100%;height:50px"></textarea>
				<br/><br/>
				<div class="clear"></div>
