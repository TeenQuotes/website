...
\begin{document}
	...
	\begin{itemize}
		...
		\item Calcul des statistiques à intervalle de temps régulier : voir les fichiers \texttt{kernel/fonctions.php} entre les lignes 184 et 934 (fonction \texttt{update\_stats}) et \texttt{cron.php}.
	\end{itemize}
